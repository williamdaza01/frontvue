...
import {
  ...
  HemisphereLight,
  Light,
  LinearSRGBColorSpace as LinearEncoding,
  Object3D,
  PerspectiveCamera,
  PointLight,
  Raycaster,
  ...
  Sprite,
  SpriteMaterial,
  SRGBColorSpace as sRGBEncoding,
  Texture,
  TextureLoader,
  Vector2,
  Vector3,
...
import {getCenter, getLoader, getMTLLoader, getSize} from "./loadModel";
...
function init() {
  ...
  if (!renderer) {
    ...
    renderer.outputColorSpace = outputEncoding === "linear" ? LinearEncoding : sRGBEncoding;
  }
